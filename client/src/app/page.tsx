      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Discover, review, and rate the latest movies. Join millions of film enthusiasts in sharing your cinematic experiences.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join our community of movie lovers and start reviewing your favorite films today.
          </p>
          <Link
            href="/auth"
            className="inline-block bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105"
          >
            Get Started
          </Link>
        </div>
